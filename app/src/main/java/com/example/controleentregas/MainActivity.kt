...
class MainActivity : BaseActivity() {
    ...
    private lateinit var listView: ListView // elemento para mostrar a lista de Entregas.
    private lateinit var inputTask: EditText // campo de texto para digitar a Entrega.
    private lateinit var addButton: Button // botão para adicionar novas Entregas.

    private lateinit var filterPending: TextView
    private lateinit var filterDone: TextView
    private lateinit var filterAll: TextView

    private lateinit var tasks: MutableList<Task> // lista que armazena as Entregas adicionadas.
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Assim, poder salvar e carregar Entregas da memória persistente (armazenamento interno do app).
        taskStorage = TaskStorage(this)

        //Chama o método loadTasks() da TaskStorage que
        //Lê as Entregas salvas no SharedPreferences
        //Usa Gson para converter o JSON de volta em uma List<Task>
        // usa .toMutableList() para transformar a lista carregada em uma lista mutável, permitindo adicionar, editar e remover Entregas.
        ...
        addButton.setOnClickListener {
            ...
            if (text.isNotEmpty()) {    // Quando clicado, ele verifica se o campo de texto não está vazio.
                ...
                Toast.makeText(this, "Digite uma Entrega para adicionar.", Toast.LENGTH_SHORT).show() // Caso contrário, uma mensagem de erro é exibida
            }
        }
    ...
    //Ao clicar em qualquer item da lista, uma caixa de diálogo aparecerá com a Entrega atual preenchida.
        ...
        AlertDialog.Builder(this)
            ...
            .setPositiveButton("Salvar") { _, _ ->
                ...
                if (newText.isNotEmpty()) {
                    ...
                    Toast.makeText(this, "A Entrega não pode estar vazia.", Toast.LENGTH_SHORT)
                        .show()
                }
            }
    ...
    // TaskAdapter é uma classe interna que estende BaseAdapter. Ela fornece os métodos necessários para gerenciar a lista de entregas.
    inner class TaskAdapter : BaseAdapter() {
        ...
        // Ele cria um layout com um CheckBox e um ImageButton para deletar a Entrega.
        //Quando o botão de deletar é clicado, a Entrega correspondente é removida da lista.
        override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
            ...
            viewHolder.deleteButton.setOnClickListener {
                // Identifica qual Entrega deve ser removida, baseando-se na lista atualmente exibida (filtrada).
                val taskToRemove = filteredTasks[position]
                // Remove esse mesmo objeto da lista completa de Entregas.
            ...
            // editar Entrega com clique longo no item da lista
            view.setOnClickListener {
                ...
                // Caso contrário, algo deu errado (objeto não achado) e é exibida uma mensagem de erro
                    ...
                    Toast.makeText(this@MainActivity, "Erro ao editar a entrega", Toast.LENGTH_SHORT)
                        .show()
                }
            }
            return view
